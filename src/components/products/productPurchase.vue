    ...
    <div class="row">
        <div class="col-6 offset-3 pt-3 card mt-5 shadow">
            <div class="card-body">
                ...
                <hr>
                <button class="btn btn-primary"  :disabled=saveDisabled @click="saveProduct">Kaydet</button>
            </div>
        </div>
    </div>
</div>
...
export default {
 ...
 if(!this.saveButtonClick && (this.product.title.length>0 || this.product.count>0 || this.product.price>0 || this.product.description.length>0))
 {
